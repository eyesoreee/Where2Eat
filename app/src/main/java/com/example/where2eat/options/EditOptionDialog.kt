...
fun EditOptionDialog(
    ...
    LaunchedEffect(option) {
        ...
        ratingInput = option.option.rating?.toString() ?: ""
        selectedPriceRange = option.option.priceRange
        isFavorite = option.option.isFavorite
        isOpen = option.option.isOpen
        nameTouched = false
    }
        ...
        confirmButton = {
            TextButton(
                onClick = {
                    ...
                    val optionWithTags = OptionWithTags(
                        option = option,
                        tags = selectedTags
                    )
